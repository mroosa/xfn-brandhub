<div class="col-1">
  ...
  <a class="button internal-download" href="files/xfinity-typography.zip"><span>Download Typefaces</span></a>
</div>
    ...
    <div class="tab" id="typography_examples" data-ttl="Type Examples">
      <div class="tab-inner">
        ...
        <ul class="optionWrap animate">
          ...
          <li data-alt="Type Example 3"><img style="max-height: 250px;" class="border rounded" src="<?php print $dir; ?>images/typography/type-ex-2.png" alt="" /></li>
        </ul>
      </div>
    </div><!-- /.section -->
  </div>
